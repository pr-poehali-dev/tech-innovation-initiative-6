...
const partners = [
  ...
  { name: "Pragmatic", icon: Sun },
  { name: "Evolution", icon: Diamond },
  { name: "Play'n GO", icon: Bird },
  { name: "Microgaming", icon: Activity },
  { name: "Yggdrasil", icon: Zap },
  { name: "Quickspin", icon: Circle },
]
