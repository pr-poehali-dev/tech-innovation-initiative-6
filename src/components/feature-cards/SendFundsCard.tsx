...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Моментальные выплаты</h3>
      <p className="mb-4 text-sm text-gray-400">Выводи выигрыши на карту или кошелёк за секунды — без задержек и скрытых комиссий</p>
      ...
      <div className="mt-auto space-y-4 rounded-xl bg-[#1a1a1a] border border-[#262626] p-4">
        <div className="flex items-center justify-between rounded-lg bg-[#0f0f0f] border border-[#262626] px-3 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Доступно к выводу: 87 500 ₽</p>
            </div>
          </div>
        ...
        <div>
          <label className="mb-2 flex items-center gap-1 text-xs text-gray-400">
            Промокод <span className="text-violet-400">*</span> (Необязательно)
          </label>
          <div className="relative">
            <textarea
              placeholder="Введите промокод для бонуса..."
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <span className="text-sm text-gray-400">Ускоренный вывод</span>
        </div>
      </div>
    </div>
  )
